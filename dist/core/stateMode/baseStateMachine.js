...
class BaseStateMachine {
    ...
    parseOptios(stateOptions) {
        const options = {
            initializationMode: utils_1.optionPriority(stateOptions, 'initialization', ['initialization', 'onDemandInitialization']),
    ...
    instantiatedState(instance, params) {
        index_1.property.hasProperty(instance, const_1.CURRENT_STATE, () => {
            warn_1.warn(`${instance.name} Please check if the function has ${const_1.CURRENT_STATE} static property!`);
        }, () => {
            this.instanceExecutionQueue.set(index_1.property.getProperty(instance, const_1.CURRENT_STATE), Reflect.construct(instance, params));
        });
    }
    /**
     * @description 等待实例化
    ...
    waitingForInstance(instance) {
        // @ts-ignore
        hasProperty(instance.fn, const_1.CURRENT_STATE, () => warn_1.warn(`${instance.fn.name} Please check if the function has ${const_1.CURRENT_STATE} static property!`), () => this.executionQueue.set(index_1.property.getProperty(instance.fn, const_1.CURRENT_STATE), {
            fn: instance.fn,
